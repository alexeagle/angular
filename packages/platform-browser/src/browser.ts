...
import {APP_ID, ApplicationModule, createPlatformFactory, ErrorHandler, ModuleWithProviders, NgModule, Optional, PLATFORM_ID, PLATFORM_INITIALIZER, platformCore, PlatformRef, Provider, RendererFactory2, RootRenderer, Sanitizer, SkipSelf, Testability} from '@angular/core';
