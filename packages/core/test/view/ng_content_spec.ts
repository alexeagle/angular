...
import {getDebugNode, Injector, RenderComponentType, RootRenderer, Sanitizer, SecurityContext, TemplateRef, ViewContainerRef, ViewEncapsulation} from '@angular/core';
import {anchorDef, asElementData, asProviderData, asTextData, attachEmbeddedView, DebugContext, detachEmbeddedView, directiveDef, elementDef, ngContentDef, NodeDef, NodeFlags, RootData, rootRenderNodes, Services, textDef, ViewData, viewDef, ViewDefinition, ViewDefinitionFactory, ViewFlags, ViewHandleEventFn, ViewUpdateFn} from '@angular/core/src/view/index';
...
export function main() {
  describe(`View NgContent`, () => {
    ...
    function hostElDef(contentNodes: NodeDef[], viewNodes: NodeDef[]): NodeDef[] {
      ...
      return [
        elementDef(
            NodeFlags.None, null!, null!, 1 + contentNodes.length, 'acomp', null!, null!, null!,
            null!, () => aCompViewDef),
    ...
    it('should project already attached embedded views', () => {
      ...
      const {view, rootNodes} = createAndGetRootNodes(compViewDef(hostElDef(
          [
            anchorDef(NodeFlags.EmbeddedViews, null!, 0, 1, null!, embeddedViewDef([textDef(
                                                                       null!, ['a'])])),
            directiveDef(
